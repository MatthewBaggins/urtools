...
from urtools.func.compose import assert_composable
...
def test_assert_composable(f1, f2, expected):
...
from urtools.func.compose import compose2
...
@pytest.mark.parametrize(('f1', 'f2', 'inputs', 'expected'),
                            ...
                            (square, cube, [2], 64),
                            (add, square, [2, 3], 25)))
def test_compose2(f1, f2, inputs, expected):
